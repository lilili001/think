...
return array(
	...
	'DEFAULT_THEME'=>'default',
        ...
        //过滤HTML，如果去掉了，则传递包含HTML的字符串，将不过滤 用于url中转义html为字符串 不输出html
        'DEFAULT_FILTER'=>'htmlspecialchars',
    
        //设置操作绑定到类 如果设置了这个 那么控制器下所有的都必须用文件夹形式
        ...
        //SESSION前缀 加了前缀的session 是把前缀当作数组的 name 设置的session是这个数组的成员 类似下面
        //在user控制器 session方法中可查看 session设置方法
        /*
            Array
            (
                [user] => Mr.Lees
